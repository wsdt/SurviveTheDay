    ...
    public void onDateSet(DatePicker view, int year, int month, int day) {
        ...
        TimePickerFragment tmpTimePicker = new TimePickerFragment(getActivity(), new MyTimePickerDialog.OnTimeSetListener() {
            ...
            public void onTimeSet(TimePicker view, int hourOfDay, int minute, int seconds) {
                ...
                getResultView().setText(String.format(getRes().getString(R.string.dateTimePicker_format_DateTime),getResultView().getText(),String.format(IGlobal.GLOBAL.LOCALE,"%02d", hourOfDay),String.format(IGlobal.GLOBAL.LOCALE,"%02d", minute),String.format(IGlobal.GLOBAL.LOCALE,"%02d", seconds)));
